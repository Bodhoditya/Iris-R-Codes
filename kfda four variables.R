...
train=Data
test=Data
traindata=train[,c(1,2,3,4,5)]
testdata=test[,c(1,2,3,4)]
...
plot(pre$x, col = pre$class,pch=as.integer(test$Species), cex = 2,main="KFDA Classification Based on All Featurs")
abline(h=0,v=0)
